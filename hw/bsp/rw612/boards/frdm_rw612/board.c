...
// #include "fsl_debug_console.h"  // Not needed for TinyUSB - uses its own UART
#include "fsl_clock.h"
#include "board.h"
 ...
 * Code
 ******************************************************************************/
/* Initialize debug console - TinyUSB uses its own UART in family.c */
void BOARD_InitDebugConsole(void)
{
    /* TinyUSB initializes UART in family.c using board_uart_init_clock()
